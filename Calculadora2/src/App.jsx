...
if (/[\+\*/]{2,}/.test(input)) { // Verifica se há dois operadores seguidos
 ...
 const key = (e) => {
      ...
      } else if (keyPressed === 'Enter') { calculate(e);
         
      } else if (keyPressed === 'Backspace') { clean();
         
      } else if (keyPressed === 'Escape') { clearDisplay();
         
      } else if ((keyPressed === '+' || keyPressed === '-' || keyPressed === '*' || keyPressed === '/')) { setInput(prev => prev + keyPressed);
         
      } else if (keyPressed === '.') { setInput(prev => prev + keyPressed);
